...
const UseRazorPay = () => {
  ...
  const handlePayment = async (
    ...
    const options: RazorpayOptions = {
      key: 'rzp_test_5uVMCNdJGu9j6M', // Enter the Key ID generated from the Dashboard rzp_test_OOrMIZgN8sK1m2
      ...
      name: localStorage.getItem('schoolName') || order?.name || 'Ex-Learning',
      description: order?.description ?? 'Test Transaction',
      image:
        `${BASE_URI}/${localStorage.getItem('schoolLogo')}` ||
        order?.image ||
