...
export const facultyApi = {
  ...
  GetSubjectByFId: '/time-table/get-subject-by-fid',
  getStudentById: '/student/get-student-by-id',
  getTermById: '/terms/get-terms-by-id',
  getResultById: '/scholastic-result/get-result-by-id',
  getResultByStudent: '/scholastic-result/get-result-by-student-id',
  createScholasticResult: '/scholastic-result/create-result',
  updateScholasticResult: '/scholastic-result/update-result',
  getOtherSubjectByFacultyId:
    '/scholastic-result/get-other-subject-by-faculty-id'
} as const;
...
export const circularApi = {
  ...
  updateActionBtn: '/circular-event/update-action-btn'
};
